...
counts<-read.table(file='/Users/banditaadhikari/Desktop/backup_to_googleDrive/Aspergillus/final_de/michael_advice/col4_aug/countmatrix_aug_col4.csv', header=TRUE,row.names=1)
```

```{r}
## this is example code for hour 4 comparison, All comparisons are same. Change names appropriately. 
samples <- read.table(file='/Users/banditaadhikari/Desktop/backup_to_googleDrive/Aspergillus/final_de/michael_advice/col4_aug/sample4h.txt', header=TRUE,sep='\t',row.names=1,colClasses=c('factor','factor','factor')) 
